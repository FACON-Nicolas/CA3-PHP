<header class="bg-black">
    ...
    <nav class="relative px-4 py-4">
        ...
        <form class="absolute p-lg-5 inline-block" style="width: 480px">
            ...
            <div class="relative">
                ...
                <label>
                    <input type="search" class=" bg-gray-700 block w-full p-2 pl-10 text-sm text-gray-100 rounded-lg placeholder-gray-400" placeholder="Search Tumblr" required>
                </label>
            </div>
        </form>
